...
class SensorConfig
{
    public:
        ...
        // Get methods
        SENSOR_CONFIGS_t getSensorConfig();
        ...
        MOD_CFG_t getModularConfig() { return ekgConfig; }
        ...
        int    countHours(uint32_t x);
        double getAvgPowerUse();
        double getPowerUse();
    ...
    private:
        ...
        unsigned int sampleCount[SENSOR_COUNT];
